...
export default function TopBar() {
    ...
    return (
        <>
                    ...
                    <div className="flex items-center justify-between h-14">
                        ...
                        <div className='flex items-center justify-center gap-3 lg:gap-6'>
                            ...
                            <div className='hidden md:flex flex-row items-center justify-center '>
                                ...
                                <img src="https://app.lyvup.com:8443/img/user.png" className='w-8 h-8 mx-2 rounded-full' alt="" />
                            </div>
                            <div >
                                <button
            ...
            <div className={`transition-all block  h-[calc(100vh-7rem)] duration-300 mb-14 mt-14  ease-in-out bg-[#d3d3d3] ${isExpanded ? 'w-64' : 'w-20'}`}>

                <nav className={`p-2 py-4 flex flex-col gap-2 text-gray-400'`}>
